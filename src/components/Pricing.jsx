...
const Pricing = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <div className="flex mx-auto border-2 border-[#f56d7d] rounded overflow-hidden mt-6">
        <button className="py-1 px-4 bg-[#f56d7d] text-white focus:outline-none">Monthly</button>
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-[#f56d7d] flex flex-col relative overflow-hidden">
          <span className="bg-[#f56d7d] text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">POPULAR</span>
          ...
          <button className="flex items-center mt-auto text-white bg-[#f17684] border-0 py-2 px-4 w-full focus:outline-none hover:bg-[#f86576] rounded">Button
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>

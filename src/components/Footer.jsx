...
const Footer = () => {
  return (
    <section >
        <footer className="text-gray-600 body-font bg-[#fda4af]">
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">About TheBeauty</a>
          </li>
          <li>
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">The Science</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Sell Here</a>
          </li>
          <li>
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Advertise Your Product</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Global Selling</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Pay</a>
          </li>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Returns Center</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Recall and Product Safety</a>
          </li>
          <li>
